...
Since the last column shows the percentage change from 2015-2016 we need to drop this column as it will not be accurate once the data is transformed. We also need should note, the 6th row shows NYC overall.
