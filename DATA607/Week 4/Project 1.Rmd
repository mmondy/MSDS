...
##Find the opponent number from the round variables using regex
...
##Create final data frame with the just the fields needed
```{r}
...
##Strip out the white space from player name... as well as fix the average column. 
