...
The distrbution is symmetric and fairly normal. It has a slight right skew with some data trailing off past 4000 square feet. The center is at 1500.
...
The sample is more right skewed than the population distribution. It is still unimodal and fairly symmetric.     
...
The mean of samp2 is less than the mean of samp1. Both were less than the population mean. 
I would think the sample of size 1000 would provide a more accurate estimate of the population mean.
...
There are 5000 elements in sample_means50. The sampling distribution is unimodal and symmetric. It is fairly normal. The center is at 1500 which is the same as the population. 
I think the distribution would still be centered at 1500, but possibly have less variability. 
...
There are 100 elements in the sample_means_small vector. Each element represents the mean of a sample of size 50 from the area population
...
As the sample size increase, the center is becomes closer to the population center and the spread decreases.
...
-   Take a random sample of size 50 from `price`. Using this sample, what is 
    ...
    Point estimate for the population mean is 189416.7
...
The sampling distribution is unimodal and symmetric, fairly normal. I would guess the mean home price of the population is around 180,000. The population mean is 180,796.1
...
This distribution is also unimodal and symmetric. The sampling distribution of samples of size 150 has less variability than the distribution of samples of size 50. I would guess the mean sale price of homes in Ames would be around 180,000.   
...
The histogram of sample_means150 has a smaller spread. We would prefer a distribution with a small spread.
