...
2.  The title of the report is "Global Index of Religiosity and Atheism". To
  ...
  We must assume that it is a random sample. 
...
3.  What does each row of Table 6 correspond to? What does each row of 
    ...
    Each row of Table 6 corresponds to a country. Each row of the atheism datafram corresponds to an individuals response. 
