...
2.  The title of the report is "Global Index of Religiosity and Atheism". To
  ...
  We must assume that it is a random sample and the observations are independent. It does seem like a reasonable assumption. 
...
3.  What does each row of Table 6 correspond to? What does each row of 
    ...
    Each row of Table 6 corresponds to a country. Each row of the atheism dataframe corresponds to an individual response to the survey. 
...
4.  Using the command below, create a new dataframe called `us12` that contains
    ...
    Yes, the proportion of atheist responses agrees with the percentage in Table 6.
...
I am confident the conditions are met
...
As the population proportion gets closer to 50%, the margin of error increases, and as the population proportion approached 100% the margin of error decreases again.

A 50% population proportion will have the largest margin of error.
...
The sampling distribution of sample proportions is symmetric and unimodal. It appears to follow the normal distribution and is centered at 0.09969 with a standard deviation of 0.00929  
```{r}
mean(p_hats)
sd(p_hats)
```
...
The new sampling distributions are symmetric and unimodal. Based on these histogram, $n$ appear to affect the spread of the distribution. As $n$ increases, the spread decreases. $p$ appears to affect the center of the sampling distribution. 
...
11. If you refer to Table 6, you'll find that Australia has a sample 
    ...
    The shae of their sampling distributions does suggest they follow the normal distribution. However, the conditions are not met for Ecuador since .02*400 = 8. I think it would be sensible to proceed with inference and report on margin of errors for Australia. 
...
Null Hypothesis: There is no difference in the atheism index for spain between 2005 and 2012.
Alternative Hypothesis: There is a difference in the atheism index for spain between 2005 and 2012.
...
Conclusion: Since the confidence intervals overlap, the data do not provide convincing evidence of a change in the atheism index for spain between 2005 and 2012.


    **b.** Is there convincing evidence that the United States has seen a
    change in its atheism index between 2005 and 2012?

Null Hypothesis: There is no difference in the atheism index for the US between 2005 and 2012.
Alternative Hypothesis: There is a difference in the atheism index for the US between 2005 and 2012.
...
Conclusion: Since the confidence intervals do no overlap, the data do provide convincing evidence of a change in the atheism index for the US between 2005 and 2012.
...
Using $p$=.50 will give the most conservative Margin of error.

1.96*sqrt((.5*.5)/n) <= .01

You would need to sample 9604 people to ensure that you are within the guidelines
```{r}
(.5*.5)/(0.01/1.96)^2
```
