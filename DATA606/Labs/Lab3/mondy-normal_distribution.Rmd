...
Both distributions are unimodal and fairly symmetric. The center of the womens histograms is lower than that of men, with less variation.
...
Yes, it does appear that the data follow a nearly normal distribution. The normal curve approximates the data fairly well.
...
We still see some points towards the tails that do not fall on the line. It is pretty similar to the results of the real data.
...
Yes, the points towards the tails do not fall on the line for many of these plots. They look very similar to the probability plot for fdims$hgt. I think they provide evident that female heights are nearly normal.

5.  Using the same technique, determine whether or not female weights appear to 
    come from a normal distribution.
    
I'm assuming you meant male heights:
Male heights appear to come from a normal distribution as well.
...
Both questions are below (a and b). The question around weight agreed better between the theorical and empircal probabilities.
    
  a) What is the probability that that a randomly chosen young adult female is shorter than 5 feet (about 152 cm)?
...
```
  ...
  b) What is the probability that that a randomly chosen young adult female is weights more the 150 lbs (about 68 kg)?
...
D definitely shows a stepwise pattern because the values of age are only whole numbers.
...
Knee diameter appears to be right skewed. 
